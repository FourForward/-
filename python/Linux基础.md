...
* Linux 诞生
    ...
    ![Linus](Linux基础.assets/linus.png)
...
* Linux系统构成
    ...
    * 应用软件：包含桌面系统和基础的软件操作工具等。
    ...
    ![Linux](Linux基础.assets/linux.jpg)
...
* 文件系统结构
    ...
    * 熟悉的windows文件系统，分不同盘符
    ...
    ![windows上文件系统](Linux基础.assets/win.png)

    * Linux的文件组织中没有盘符。将根（/）作为整个文件系统的唯一起点，其他所有目录都从该点出发。

![Linux文件系统](Linux基础.assets/Linux_f.png)

​    

  犹如一颗倒置的树，所有存储设备作为这颗树的一个子目录。

![Linux](Linux基础.assets/linux_fs.jpg)
...
![ubuntu](Linux基础.assets/ubuntu.png)
...
![image-20200803000114913](Linux基础.assets/image-20200803000114913.png)
...
![](Linux基础.assets/1.png)

2. 修改文件的执行权限

![](Linux基础.assets/2.png)

3. 执行代码

![](Linux基础.assets/3.png)

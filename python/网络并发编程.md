...
![](网络并发编程.assets/1_四次挥手.png)

#### 1.3.2 TCP服务端



![](网络并发编程.assets/1_TCP_Server.png)
...
![](网络并发编程.assets/1_TCP_Client.png)
...
![](网络并发编程.assets/14.png)



#### 1.4.2 TCP协议首部（了解）

![](网络并发编程.assets/1_tcp数据包.png)
...
* 计算机原理 
    ...
    * CPU：计算机硬件的核心部件，用于对任务进行执行运算。
        ...
        ![](网络并发编程.assets/14.jpg)

    * 操作系统调用CPU执行任务

        ![](网络并发编程.assets/15.png)
...
* 多任务意义
    ...
    * 充分利用计算机资源，提高了任务的执行效率。
        ...
        * 在任务中无阻塞时只有并行状态才能提高效率
        ...
        ![](网络并发编程.assets/17.jpg)

        

        * 在任务中有阻塞时并行并发都能提高效率

        ![](网络并发编程.assets/18.jpg)
...
* 线程特征
    ...
    ![](网络并发编程.assets/21.jpg)

#### 2.3.2 多线程编程

* 线程模块： threading

![](网络并发编程.assets/22.jpg)
...
* 同步互斥机制
    ...
    * 同步 ： 同步是一种协作关系，为完成操作，多进程或者线程间形成一种协调，按照必要的步骤有序执行操作。
        ...
        ![](网络并发编程.assets/7_同步.png)

    * 互斥 ： 互斥是一种制约关系，当一个进程或者线程占有资源时会进行加锁处理，此时其他进程线程就无法操作该资源，直到解锁后才能操作。

![](网络并发编程.assets/7_互斥.png)

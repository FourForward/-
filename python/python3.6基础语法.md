...
![image-20211003221451988](python3.6基础语法.assets/image-20211003221451988.png)
...
![image-20211003221523819](python3.6基础语法.assets/image-20211003221523819.png)
...
![image-20211003221700498](python3.6基础语法.assets/image-20211003221700498.png)
...
![image-20211003221721867](python3.6基础语法.assets/image-20211003221721867.png)
...
![image-20211003232850079](python3.6基础语法.assets/image-20211003232850079.png)
...
2. 语法：
    ...
    <font color='red'>容器[开始索引:结束索引:步长] </font>

    <font color='blue'>步长的正负决定取值的方向。开始和结束的索引决定的不仅仅是取值区间，同样决定着步长的正负，如果索引方向和步长正负不匹配，值为空</font>
...
![image-20211003233405661](python3.6基础语法.assets/image-20211003233405661.png)
...
![image-20211003234813697](python3.6基础语法.assets/image-20211003234813697.png)
...
![image-20211003235300217](python3.6基础语法.assets/image-20211003235300217.png)
...
![image-20211003235651551](python3.6基础语法.assets/image-20211003235651551.png)

![image-20211003235700425](python3.6基础语法.assets/image-20211003235700425.png)

![image-20211003235707994](python3.6基础语法.assets/image-20211003235707994.png)
...
![image-20211003235805539](python3.6基础语法.assets/image-20211003235805539.png)



![image-20211004000022525](python3.6基础语法.assets/image-20211004000022525.png)

![image-20211004000052530](python3.6基础语法.assets/image-20211004000052530.png)
...
5. 函数：
    ...
    启发：<font color='red'>再对不可变对象进行频繁修改,就先存储到可变对象中,最后再还原为不可变对象。</font>
     										...
     										![image-20211004000522160](python3.6基础语法.assets/image-20211004000522160.png)
    
    将一个字符串拆分为多个。
    
    列表 = “a-b-c-d”.split(“分隔符”)

![image-20211004000540050](python3.6基础语法.assets/image-20211004000540050.png)
...
![image-20211004000725566](python3.6基础语法.assets/image-20211004000725566.png)
...
![image-20211004103639531](python3.6基础语法.assets/image-20211004103639531.png)



![image-20211004103753613](python3.6基础语法.assets/image-20211004103753613.png)
...
![image-20211004104707307](python3.6基础语法.assets/image-20211004104707307.png)
...
![image-20211004110014719](python3.6基础语法.assets/image-20211004110014719.png)

![image-20211004110022866](python3.6基础语法.assets/image-20211004110022866.png)
...
![image-20211004111954387](python3.6基础语法.assets/image-20211004111954387.png)

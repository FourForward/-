...
- **顺序表的基本形式**
    ...
    ![](数据结构.assets/QQ截图20200616114526.png)
...
- ![recure1](数据结构.assets/recure1.png)
...
- **递归示例2**
    ...
    ![recure2](数据结构.assets/recure2.png)
...
- **递归示例3**
    ...
    ![recure3](数据结构.assets/recure3.png)
...
- **递归动态图解一**
    ...
    ![](数据结构.assets/recuregif2.gif)

- **递归动态图解二**

    ![](数据结构.assets/recuregif3.gif)

- **递归动态图解三**

    ![](我的笔记园/小玉的玉/python/数据结构and算法/img/recuregif1.gif)
...
- **二分查找图解一**
    ...
    ![](数据结构.assets/binraysearch1.jpg)

- **二分查找图解二**

    ![](数据结构.assets/binarysearch2.gif)

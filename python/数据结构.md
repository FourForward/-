...
- **顺序表的基本形式**
    ...
    ![](img/数据结构/QQ截图20200616114526.png)
...
- **递归动态图解一**
    ...
    ![](img/数据结构/recuregif2.gif)

- **递归动态图解二**

    ![](img/数据结构/recuregif3.gif)
...
- **二分查找图解一**
    ...
    ![](img/数据结构/binraysearch1.jpg)

- **二分查找图解二**

    ![](img/数据结构/binarysearch2.gif)
